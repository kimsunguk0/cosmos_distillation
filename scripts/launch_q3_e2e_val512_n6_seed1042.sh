...
OUT_DIR="outputs/action_expert/q3_e2e_val512_n6_seed42_evalbase1042_20260604"
mkdir -p "$OUT_DIR"
exec >> "$OUT_DIR/run.log" 2>&1

echo "{\"event\":\"q3_e2e_n6_launch\",\"time\":\"$(date -Is)\",\"out_dir\":\"$OUT_DIR\",\"eval_samples\":512,\"eval_num_paths\":6,\"seed\":42,\"eval_seed_base\":1042}"

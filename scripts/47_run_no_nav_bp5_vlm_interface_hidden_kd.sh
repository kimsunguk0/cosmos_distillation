...
RUN_ID="${RUN_ID:-no_nav_bp5_vlm_interface_hidden_kd_$(date +%Y%m%d_%H%M%S)}"
...
OUTPUT_DIR="${OUTPUT_DIR:-$ROOT_DIR/outputs/checkpoints/no_nav_bp5_vlm_interface_hidden_kd/$RUN_ID}"

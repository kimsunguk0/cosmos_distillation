...
RUN_ID="run2_20k_fp8vit_late_onpolicy_from_step006250_val512_b8"
...
CONFIG="configs/train/stage_b0_fp8_old_recipe_20k_late_onpolicy.yaml"

mkdir -p "logs/${RUN_ROOT}" "outputs/reports/${RUN_ROOT}" "${OUT_DIR}"

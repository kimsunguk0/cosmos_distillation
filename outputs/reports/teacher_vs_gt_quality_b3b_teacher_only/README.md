...
CSV: `outputs/reports/teacher_vs_gt_quality_b3b_teacher_only/teacher_vs_gt_quality_table.csv`
JSONL: `outputs/reports/teacher_vs_gt_quality_b3b_teacher_only/teacher_vs_gt_quality_table.jsonl`
...
- relative_kd_group counts: `{'group2_mixed_gt_primary': 736, 'group3_teacher_downweight_or_exclude': 77, 'group1_teacher_trusted': 145}`
...
- mean student ADE/FDE: `4.1855` / `12.6159`
- mean teacher-student ADE/FDE delta: `-2.6994` / `-8.4270`
...
- relative_kd_group counts: `{'group2_mixed_gt_primary': 697, 'group3_teacher_downweight_or_exclude': 57}`
...
- mean student ADE/FDE: `nan` / `nan`
- mean teacher-student ADE/FDE delta: `nan` / `nan`
...
- relative_kd_group counts: `{'group2_mixed_gt_primary': 39, 'group3_teacher_downweight_or_exclude': 20, 'group1_teacher_trusted': 145}`
...
- mean student ADE/FDE: `3.6412` / `11.0099`
- mean teacher-student ADE/FDE delta: `-2.8387` / `-8.9190`
...
- mean student ADE/FDE: `5.7801` / `17.4966`
- mean teacher-student ADE/FDE delta: `-3.4243` / `-10.5854`
...
- mean student ADE/FDE: `7.1947` / `21.2466`
- mean teacher-student ADE/FDE delta: `-1.3662` / `-3.7263`
...
- mean student ADE/FDE: `3.9639` / `11.8432`
- mean teacher-student ADE/FDE delta: `-0.6912` / `-2.3132`
...
- samples: `145`
- mean teacher ADE/FDE: `0.7900` / `2.0589`
- mean student ADE/FDE: `3.7768` / `11.4232`
- mean teacher-student ADE/FDE delta: `-2.9868` / `-9.3642`
- teacher failure tags: `{'ok_or_low_error': 138, 'C_speed_scale_failure': 3, 'E_long_horizon_divergence': 3, 'A_stop_or_decel_failure': 3}`
- prefix_teacher_good: `144`

### group2_mixed_gt_primary

- samples: `736`
- mean teacher ADE/FDE: `1.2085` / `3.3164`
- mean student ADE/FDE: `5.0876` / `15.2334`
- mean teacher-student ADE/FDE delta: `-2.7470` / `-8.4470`
- teacher failure tags: `{'ok_or_low_error': 517, 'E_long_horizon_divergence': 187, 'C_speed_scale_failure': 69, 'B_curvature_or_lateral_failure': 29, 'A_stop_or_decel_failure': 13, 'F_repetition_or_local_band_oscillation': 6, 'B_curvature_or_turn_direction_failure': 5}`
- prefix_teacher_good: `733`

### group3_teacher_downweight_or_exclude

- samples: `77`
- mean teacher ADE/FDE: `5.3042` / `16.4649`
- mean student ADE/FDE: `5.3898` / `16.1586`
- mean teacher-student ADE/FDE delta: `-0.5225` / `-1.5930`
- teacher failure tags: `{'E_long_horizon_divergence': 75, 'C_speed_scale_failure': 39, 'B_curvature_or_lateral_failure': 21, 'A_stop_or_decel_failure': 10, 'D_initial_prefix_failure': 5, 'B_curvature_or_turn_direction_failure': 3, 'ok_or_low_error': 1}`
- prefix_teacher_good: `68`

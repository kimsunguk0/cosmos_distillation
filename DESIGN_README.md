# Cosmos Distillation Design README

This is the original project/design README that used to live at the repository root.
The root [README.md](./README.md) now tracks the current trajectory-collapse status and next steps.
